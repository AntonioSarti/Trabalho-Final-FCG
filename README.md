...
O trabalho desenvolvido na disciplina Fundamentos de Computação Gráfica (FCG) - INF01047, da UFRGS, consiste na implementação de uma fase de um jogo inspirado no gênero *Zombie Survival Game*. O jogo apresenta mecânicas intuitivas de movimentação e combate, 
onde o jogador enfrenta o *Zombie Boss*. O principal objetivo é sobreviver aos ataques constantes do inimigo, revidando de forma estratégica para infligir danos suficientes e, assim, derrotá-lo.
